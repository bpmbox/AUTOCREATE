...
SUPABASE_SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJvb3RvbXpidWNvdndkcXNzY3FkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDI4NTg2MSwiZXhwIjoyMDQ5ODYxODYxfQ.K7HD9fF48gYfJqNM1Gn9rnKYGfWlXmzSzFm5hUNt1qY"
...
def run_curl_command(method, url, data=None):
    ...
    try:
        ...
        curl_headers = [
            ...
            f"Authorization: Bearer {SUPABASE_SERVICE_KEY}",
            f"apikey: {SUPABASE_SERVICE_KEY}"
        ]
    ...
    while True:
        try:
            ...
            if not messages:
                print("❌ メッセージ取得失敗")
                time.sleep(5)
                continue            if isinstance(messages, list):
