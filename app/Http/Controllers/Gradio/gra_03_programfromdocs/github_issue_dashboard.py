...
base_path = os.path.join(project_root, "app", "Http", "Controllers", "Gradio", "gra_03_programfromdocs")
    ...
    def get_system_status(self):
        ...
        try:
            try:
                ...
                prompt_db = get_db_path('prompts')
            except:
                prompt_db = os.path.join(project_root, 'database', 'prompts.db')
